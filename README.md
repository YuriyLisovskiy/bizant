...
### License
Block Chain Go is licensed under the terms of the GNU General Public License v3.0, see the [LICENSE](LICENSE) file for more information or see https://opensource.org/licenses/GPL-3.0
